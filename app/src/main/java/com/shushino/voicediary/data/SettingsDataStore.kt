package com.shushino.voicediary.data
...
class SettingsDataStore @Inject constructor(
    ...
    val colorPalette: Flow<ColorPalette> = context.dataStore.data
        .map { preferences ->
            val paletteStr = preferences[colorPaletteKey] ?: ColorPalette.DEFAULT.name
            try { ColorPalette.valueOf(paletteStr) } catch (e: Exception) { ColorPalette.DEFAULT }
        }
...
enum class ColorPalette { DEFAULT, OCEAN, FOREST, SUNSET, ROSE, SLATE }
